...
export const models: { [key: string]: ModelPackage } = {
  pearai_model: {
    title: "ascende.ai Model (Recommended)",
    description:
      "Experience seamless, fully-managed LLM integration with ascende.ai, featuring the most advanced and current best-in-market language model.",
    params: {
      model: "pearai_model",
